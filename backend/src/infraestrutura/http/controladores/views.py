...
from src.infraestrutura.persistencia.django.repositorios.repositorio_interacao_django import RepositorioInteracaoChatDjango
...
class CriarInteracaoChatView(APIView):
    ...
    def post(self, request):
        ...
        # 2. Injeção de Dependência Manual (Instanciar Repositórios e Caso de Uso)
